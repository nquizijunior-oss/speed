    ...
    const entries = Object.fromEntries(
      candidats.map((candidate) => [
        candidate.id,
        {
          ...
          age: getStoredString(`candidatEditAge:${candidate.id}`, String(candidate.age)),
        },
      ])
    );
    return entries;
  ...
  useEffect(() => {
    for (const candidate of candidats) {
      ...
      try {
        ...
        localStorage.setItem(`candidatEditAge:${candidate.id}`, current.age);
      } catch {
        // ignore
      }
    }
